...
//    return minioClient.putObject(PutObjectArgs.builder().bucket(bucketName).object(objectName).contentType(contentType).stream(inputStream, file.getSize(), -1).build());
//  }
//  /**
//   * 图片上传
//   *
