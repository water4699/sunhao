...
<!--      </el-form-item>-->
    ...
    <el-table v-loading="loading" :data="levelList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="年级排列" align="center" prop="gradeId" />
      <el-table-column label="年级名称" align="center" prop="name" />
      <el-table-column label="学段" align="center" prop="educationStage" />
...
<script>
import { listLevel, getLevel, delLevel, addLevel, updateLevel } from "@/api/my/level"
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getLevel(gradeId).then(response => {
