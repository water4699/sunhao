<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="学生id" prop="createdAt">
    ...
    <el-table v-loading="loading" :data="reviewList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学生id" align="center" prop="reviewId" />
      <el-table-column label="学生ID" align="center" prop="studentId" />
      <el-table-column label="教师ID" align="center" prop="teacherId" />
      <el-table-column label="课程预约ID" align="center" prop="bookingId" />
      <el-table-column label="评分(1-5)" align="center" prop="rating" />
      <el-table-column label="评论文本" align="center" prop="comment" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="评论文本" prop="comment">
...
<script>
import { listReview, getReview, delReview, addReview, updateReview } from "@/api/my/review"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        bookingId: [
          { required: true, message: "课程预约ID不能为空", trigger: "blur" }
        ],
        rating: [
          { required: true, message: "评分(1-5)不能为空", trigger: "blur" }
        ],
        status: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除评价编号为"' + reviewIds + '"的数据项？').then(function() {
