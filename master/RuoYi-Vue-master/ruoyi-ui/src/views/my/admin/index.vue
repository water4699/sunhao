...
<!--        </el-date-picker>-->
<!--      </el-form-item>-->
<!--      <el-form-item label="用户编号" prop="createdAt">-->
<!--        <el-date-picker clearable-->
...
<!--      </el-form-item>-->
    ...
    <el-table v-loading="loading" :data="adminList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="管理员姓名" align="center" prop="fullName" />
      <el-table-column label="管理员角色" align="center" prop="role" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="管理员姓名" prop="fullName">
          <el-input v-model="form.fullName" placeholder="请输入管理员姓名" />
        </el-form-item>
        <el-form-item label="邮箱" prop="email">
...
<script>
import { listAdmin, getAdmin, delAdmin, addAdmin, updateAdmin } from "@/api/my/admin"
