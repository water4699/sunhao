...
<!--      <el-form-item label="实际支付金额" prop="finalAmount">-->
<!--        <el-input-->
...
<!--        />-->
<!--      </el-form-item>-->
<!--      <el-form-item label="支付平台交易ID" prop="transactionId">-->
<!--        <el-input-->
<!--          v-model="queryParams.transactionId"-->
<!--          placeholder="请输入支付平台交易ID"-->
<!--          clearable-->
<!--          @keyup.enter.native="handleQuery"-->
<!--        />-->
<!--      </el-form-item>-->
...
<!--      </el-form-item>-->
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="课程排序" align="center" prop="orderId" />
      <el-table-column label="用户ID" align="center" prop="userId" />
      <el-table-column label="关联课程" align="center" prop="courseId" />
      <el-table-column label="优惠活动" align="center" prop="promotionId" />
      <el-table-column label="订单金额" align="center" prop="amount" />
      <el-table-column label="折扣金额" align="center" prop="discountAmount" />
      <el-table-column label="实际支付金额" align="center" prop="finalAmount" />
<!--      <el-table-column label="支付方式" align="center" prop="paymentMethod" />-->
      <el-table-column label="支付状态" align="center" prop="paymentStatus" />
<!--      <el-table-column label="支付平台交易ID" align="center" prop="transactionId" />-->
...
<!--      </el-table-column>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="实际支付金额" prop="finalAmount">
          <el-input v-model="form.finalAmount" placeholder="请输入实际支付金额" />
        </el-form-item>
        <el-form-item label="支付平台交易ID" prop="transactionId">
          <el-input v-model="form.transactionId" placeholder="请输入支付平台交易ID" />
        </el-form-item>
        <el-form-item label="${comment}" prop="createdAt">
          <el-date-picker clearable
...
<script>
import { listOrder, getOrder, delOrder, addOrder, updateOrder } from "@/api/my/order"
