<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="星期几(1-7)" prop="weekday">
        <el-input
          v-model="queryParams.weekday"
          placeholder="请输入星期几(1-7)"
          clearable
    ...
    <el-table v-loading="loading" :data="scheduleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="scheduleId" />
      <el-table-column label="教室ID" align="center" prop="classroomId" />
      <el-table-column label="星期几(1-7)" align="center" prop="weekday" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="星期几(1-7)" prop="weekday">
          <el-input v-model="form.weekday" placeholder="请输入星期几(1-7)" />
        </el-form-item>
        <el-form-item label="开始时间" prop="startTime">
          <el-date-picker clearable
...
<script>
import { listSchedule, getSchedule, delSchedule, addSchedule, updateSchedule } from "@/api/my/schedule"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        weekday: [
          { required: true, message: "星期几(1-7)不能为空", trigger: "blur" }
        ],
        startTime: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除教室时间编号为"' + scheduleIds + '"的数据项？').then(function() {
