...
<!--      </el-form-item>-->
    ...
    <el-table v-loading="loading" :data="cardList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="会员卡排序" align="center" prop="cardId" />
      <el-table-column label="会员卡名称" align="center" prop="cardName" />
      <el-table-column label="价格" align="center" prop="price" />
      <el-table-column label="有效次数
" align="center" prop="durationCount" />
      <el-table-column label="折扣率" align="center" prop="discountRate" />
      <el-table-column label="卡描述" align="center" prop="description" />
...
<script>
import { listCard, getCard, delCard, addCard, updateCard } from "@/api/my/card"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除会员卡类型编号为"' + cardIds + '"的数据项？').then(function() {
