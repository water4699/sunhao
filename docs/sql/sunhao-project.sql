/*
 ...
 Source Schema         : sunhao

 Target Server Type    : MySQL
 Target Server Version : 90500 (9.5.0)
 File Encoding         : 65001

 Date: 02/04/2026 14:08:07
*/
...
CREATE TABLE `admin` (
  ...
  `full_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '管理员姓名',
  `role` enum('super','finance','content','support') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'support' COMMENT '管理员角色',
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='管理员表';

-- ----------------------------
-- Table structure for area_jinan
-- ----------------------------
DROP TABLE IF EXISTS `area_jinan`;
CREATE TABLE `area_jinan` (
  ...
  `level` enum('city','district','street','school','community') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'district' COMMENT '地区级别',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`area_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='济南地区表';
...
CREATE TABLE `card` (
  ...
  `card_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '会员卡名称',
  `price` decimal(8,2) NOT NULL COMMENT '价格',
  `duration_count` int unsigned NOT NULL COMMENT '有效次数\r\n',
  `discount_rate` decimal(3,2) DEFAULT '1.00' COMMENT '折扣率',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '卡描述',
  `status` int NOT NULL DEFAULT '1' COMMENT '状态',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`card_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='会员卡类型表';
...
CREATE TABLE `classroom` (
  ...
  `location_id` int unsigned NOT NULL COMMENT '地区ID',
  ...
  `capacity` smallint unsigned NOT NULL DEFAULT '10' COMMENT '容量',
  `facilities` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '设施列表',
  `hourly_rate` decimal(7,2) NOT NULL DEFAULT '0.00' COMMENT '每小时费用',
  `status` int NOT NULL DEFAULT '1' COMMENT '状态',
  `admin_id` int unsigned NOT NULL COMMENT '管理管理员',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`classroom_id`) USING BTREE,
  KEY `fk_classroom_area` (`location_id`) USING BTREE,
  KEY `fk_classroom_admin` (`admin_id`) USING BTREE,
  KEY `idx_classroom_status` (`status`) USING BTREE,
  CONSTRAINT `fk_classroom_admin` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`admin_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_classroom_area` FOREIGN KEY (`location_id`) REFERENCES `area_jinan` (`area_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='教室表';
...
CREATE TABLE `classroom_schedule` (
  ...
  KEY `fk_schedule_classroom` (`classroom_id`) USING BTREE,
  KEY `idx_weekday_time` (`weekday`,`start_time`) USING BTREE,
  CONSTRAINT `fk_schedule_classroom` FOREIGN KEY (`classroom_id`) REFERENCES `classroom` (`classroom_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='教室时间表';
...
CREATE TABLE `course` (
  ...
  `status` int NOT NULL DEFAULT '1' COMMENT '课程状态',
  `start_date` date NOT NULL COMMENT '开始日期',
  `address` varchar(512) DEFAULT NULL COMMENT '上课地址(含时段说明)',
  `expected_hours` smallint unsigned NOT NULL COMMENT '预期课时',
  `completed_hours` smallint unsigned DEFAULT '0' COMMENT '已完成课时',
  `hourly_rate` decimal(7,2) NOT NULL COMMENT '课时费用',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`course_id`) USING BTREE,
  KEY `fk_course_student` (`student_id`) USING BTREE,
  KEY `fk_course_teacher` (`teacher_id`) USING BTREE,
  KEY `fk_course_subject` (`subject_id`) USING BTREE,
  KEY `fk_course_grade` (`grade_id`) USING BTREE,
  KEY `idx_course_status` (`status`) USING BTREE,
  CONSTRAINT `fk_course_grade` FOREIGN KEY (`grade_id`) REFERENCES `grade_level` (`grade_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_course_student` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_course_subject` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`subject_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_course_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`teacher_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='课程管理表';
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='代码生成业务表';
...
) ENGINE=InnoDB AUTO_INCREMENT=179 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='代码生成业务表字段';
...
CREATE TABLE `grade_level` (
  ...
  `education_stage` enum('preschool','primary','middle','high','university') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '学段',
  `order` tinyint unsigned NOT NULL COMMENT '排序序号',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`grade_id`) USING BTREE,
  UNIQUE KEY `name` (`name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='年级表';
...
CREATE TABLE `notification` (
  ...
  `type` enum('system','booking','payment','promotion') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'system' COMMENT '通知类型',
  `status` int NOT NULL DEFAULT '1' COMMENT '状态',
  `sent_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '发送时间',
  PRIMARY KEY (`notification_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='通知表';
...
CREATE TABLE `order` (
  ...
  `promotion_id` int unsigned DEFAULT NULL COMMENT '优惠活动',
  `amount` decimal(10,2) NOT NULL COMMENT '订单金额',
  `discount_amount` decimal(10,2) DEFAULT '0.00' COMMENT '折扣金额',
  `final_amount` decimal(10,2) NOT NULL COMMENT '实际支付金额',
  `payment_method` enum('alipay','wechat','bank','cash','credit') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'wechat' COMMENT '支付方式',
  `payment_status` int NOT NULL DEFAULT '1' COMMENT '支付状态',
  `transaction_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '支付平台交易ID',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`order_id`) USING BTREE,
  KEY `fk_order_user` (`user_id`) USING BTREE,
  KEY `fk_order_course` (`course_id`) USING BTREE,
  KEY `fk_order_promotion` (`promotion_id`) USING BTREE,
  KEY `idx_order_payment_status` (`payment_status`) USING BTREE,
  CONSTRAINT `fk_order_course` FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  CONSTRAINT `fk_order_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`users_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='订单表';
...
CREATE TABLE `product` (
  ...
  `type` enum('书籍','文具') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '书籍' COMMENT '商品类型',
  `price` decimal(10,2) NOT NULL COMMENT '价格',
  `stock` int DEFAULT NULL COMMENT '库存数量(NULL表示无限库存)',
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='商品表';
...
CREATE TABLE `product_order` (
  ...
  `order_status` enum('pending','processing','shipped','completed','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'pending' COMMENT '订单状态',
  `shipping_address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '收货地址',
  ...
  PRIMARY KEY (`order_id`) USING BTREE,
  UNIQUE KEY `uq_order_number` (`order_number`) USING BTREE COMMENT '订单号唯一索引',
  KEY `idx_user_id` (`user_id`) USING BTREE COMMENT '用户ID索引',
  KEY `idx_created_at` (`created_at`) USING BTREE COMMENT '创建时间索引',
  CONSTRAINT `fk_order-product_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='商品订单表';
...
CREATE TABLE `promotion` (
  ...
  `discount_type` enum('percentage','fixed','free') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'percentage' COMMENT '折扣类型',
  `discount_value` decimal(8,2) NOT NULL COMMENT '折扣值',
  `start_date` date NOT NULL COMMENT '开始日期',
  `end_date` date NOT NULL COMMENT '结束日期',
  `applicable_to` enum('all','first_time','members') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'all' COMMENT '适用对象',
  `usage_limit` int unsigned DEFAULT NULL COMMENT '使用次数限制',
  `status` int NOT NULL DEFAULT '1' COMMENT '状态',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`promotion_id`) USING BTREE,
  KEY `idx_promotion_status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='优惠活动表';
...
CREATE TABLE `review` (
  ...
  `student_id` int unsigned NOT NULL COMMENT '学生ID',
  `teacher_id` int unsigned NOT NULL COMMENT '教师ID',
  `booking_id` int unsigned NOT NULL COMMENT '课程预约ID',
  `rating` tinyint unsigned NOT NULL COMMENT '评分(1-5)',
  `comment` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '评论文本',
  `status` char(1) NOT NULL DEFAULT '0' COMMENT '0待审核 1已通过 2已驳回',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`review_id`) USING BTREE,
  KEY `fk_review_student` (`student_id`) USING BTREE,
  KEY `fk_review_teacher` (`teacher_id`) USING BTREE,
  CONSTRAINT `fk_review_student` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_review_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`teacher_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='评价表';
...
CREATE TABLE `student` (
  ...
  `gender` enum('M','F','O') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'M' COMMENT '性别',
  `birth_date` date DEFAULT NULL COMMENT '出生日期',
  `school` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '学校',
  `grade_level` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '年级',
  `learning_needs` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '学习需求',
  `budget` decimal(7,2) DEFAULT NULL COMMENT '预算时薪',
  `status` int NOT NULL DEFAULT '1' COMMENT '学生状态',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`student_id`) USING BTREE,
  UNIQUE KEY `uq_user_student` (`user_id`) USING BTREE,
  KEY `fk_student_subject` (`subject_id`) USING BTREE,
  CONSTRAINT `fk_student_subject` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`subject_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_student_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`users_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='学生信息表';
...
CREATE TABLE `subject` (
  ...
  `category_id` int unsigned NOT NULL COMMENT '父科目ID',
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '科目名称',
  `status` int NOT NULL DEFAULT '1' COMMENT '状态',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`subject_id` DESC) USING BTREE,
  KEY `fk_subject_category` (`category_id`) USING BTREE,
  CONSTRAINT `fk_subject_category` FOREIGN KEY (`category_id`) REFERENCES `subject_category` (`category_id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='科目表';
...
) ENGINE=InnoDB AUTO_INCREMENT=523 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='系统访问记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=2017 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='菜单权限表';
...
) ENGINE=InnoDB AUTO_INCREMENT=303 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='操作日志记录';
...
CREATE TABLE `teacher` (
  ...
  `subject_id` int(10) unsigned zerofill NOT NULL COMMENT '关联科目',
  `area_id` varchar(64) DEFAULT NULL COMMENT '地区ID(area_jinan)',
  `grade_id` varchar(64) DEFAULT NULL COMMENT '年级ID(grade_level)',
  `real_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '真实姓名',
  `gender` enum('M','W') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'M' COMMENT '性别',
  `education` enum('本科','研究生','博士生') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '学历',
  `university` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '所在大学',
  `hourly_rate` decimal(7,2) NOT NULL DEFAULT '0.00' COMMENT '时薪',
  `rating` decimal(3,2) DEFAULT '5.00' COMMENT '平均评分',
  `status` int NOT NULL DEFAULT '1' COMMENT '认证状态',
  ...
  PRIMARY KEY (`teacher_id` DESC) USING BTREE,
  UNIQUE KEY `uq_user_teacher` (`user_id`) USING BTREE,
  KEY `idx_teacher_status` (`status`) USING BTREE,
  KEY `fk_teacher_subject` (`subject_id`) USING BTREE,
  CONSTRAINT `fk_teacher_subject` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`subject_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_teacher_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`users_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='教师信息表';
...
CREATE TABLE `user_membership` (
  ...
  `end_date` date NOT NULL COMMENT '过期日期',
  `status` int NOT NULL DEFAULT '1' COMMENT '状态',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uq_user_active_card` (`user_id`) USING BTREE,
  KEY `fk_um_card` (`card_id`) USING BTREE,
  CONSTRAINT `fk_um_card` FOREIGN KEY (`card_id`) REFERENCES `membership_card` (`card_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_um_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='用户会员卡中间表';
...
CREATE TABLE `users` (
  ...
  `usersname` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户名',
  `phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '手机号',
  `email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '邮箱',
  `sex` enum('0','1','2') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '2' COMMENT '性别(0男,1女,2未知)',
  `password` varchar(100) DEFAULT NULL COMMENT 'BCrypt，业务端密码登录',
  `users_type` enum('teacher','student','parent') NOT NULL DEFAULT 'student',
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '头像',
  `status` int NOT NULL DEFAULT '1' COMMENT '账号状态',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`users_id`) USING BTREE,
  UNIQUE KEY `username` (`usersname`) USING BTREE,
  KEY `idx_user_status` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='用户总表';
